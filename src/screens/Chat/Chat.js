  ...
  const renderInputToolbar = (props) => {
    return (
        <View style={{marginTop:Utils.ScreenHeight(5) }}>
            ...
            alignSelf:"center", borderRadius:20, height:Utils.ScreenHeight(5), borderWidth:0.5, borderColor:colors.white}}

            containerStyle={{backgroundColor:'white',color:colors.white,
            marginHorizontal:Utils.ScreenWidth(5),
           alignSelf:"center", borderRadius:100, height:Utils.ScreenHeight(5), borderWidth:0.5, borderColor:colors.white}}
             {...props}
